...
class GsParititonTest(unittest.TestCase):
    def setUp(self) -> None:
        self.maxDiff = None
    ...
    def test_range_and_range_columns_partition(self):
        ...
        range_columns_part = GsRangePartition(
            True,
            range_part_infos=[
    ...
    def test_list_and_list_columns_partition(self):
        ...
        list_columns_part = GsListPartition(
            True,
            list_part_infos=[
    ...
    def test_hash_and_key_partition(self):
        hash_part = GsHashPartition("col1", part_count=60)
        self.assertEqual(
            hash_part.do_compile(), "PARTITION BY HASH (col1) PARTITIONS 60"
        )

        key_part = GsKeyPartition(col_name_list=["id", "gmt_create"], part_count=10)
        self.assertEqual(
    ...
    def test_range_columns_with_sub_parititon(self):
        ...
        range_sub_part = GsSubRangePartition(
            False,
            range_part_infos=[
        ...
        range_columns_sub_part = GsSubRangePartition(
            True,
            range_part_infos=[
                RangeListPartInfo("mp0", 1000),
                RangeListPartInfo("mp1", 2000),
        ...
        list_columns_sub_part = GsSubListPartition(
            True,
            list_part_infos=[
        ...
        hash_part = GsSubHashPartition("col2", part_count=5)
        ...
        key_part = GsSubKeyPartition(["col2"], part_count=3)
    ...
    def test_list_with_sub_partitions(self):
        ...
        hash_sub_part = GsSubHashPartition("col3", part_count=3)
        ...
        key_sub_part = GsSubKeyPartition(["col3"], part_count=3)
    ...
    def test_list_columns_with_sub_partitions(self):
        ...
        hash_sub_part = GsSubHashPartition("col2", part_count=5)
        ...
        key_sub_part = GsSubKeyPartition(["col2"], part_count=3)
    ...
    def test_hash_with_sub_partitions(self):
        hash_part = GsHashPartition("col1", part_count=5)
        range_columns_sub_part = GsSubRangePartition(
            True,
            range_part_infos=[
                RangeListPartInfo("p0", 100),
        ...
        hash_sub_part = GsSubHashPartition(
        ...
        key_sub_part = GsSubKeyPartition(
    ...
    def test_key_with_sub_partitions(self):
        key_part = GsKeyPartition(["col1"], key_part_name_list=["p0", "p1", "p2"])
        range_columns_sub_part = GsSubRangePartition(
            True,
            range_part_infos=[
                RangeListPartInfo("p0", 100),
