...
class FieldSchema:
    ...
    description (string) : field description (not used in GaussDB)
    ...
    def __init__(
        ...
        name: str,
        dtype: DataType,
        description: str = "",  # ignored in gaussdb
...
class CollectionSchema:
    ...
    Attributes:
        ...
        description (string) : collection description (not used in GaussDB)
        partitions (GsPartition) : partition strategy of this collection
    """
    def __init__(
        self,
